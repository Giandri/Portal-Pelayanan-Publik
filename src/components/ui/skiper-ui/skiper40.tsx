...
const Link001 = ({
  ...
  return (
    <a
      ...
      target="_blank"
      className={cn(
        "group w-fit relative inline items-center",
        className,
        "bg-gradient-to-r from-current to-current bg-[length:0%_1px] bg-no-repeat bg-[position:0_100%]",
...
const Link005 = ({
  ...
  return (
    <a
      ...
      className={cn(
        className,
        "group relative flex items-center transition-colors duration-300 hover:text-white",
        "before:pointer-events-none before:absolute before:left-0 before:w-full before:bg-blue-950 before:rounded-sm before:content-['']",
        ...
        "before:z-[-1] px-2 before:h-full before:scale-x-0 hover:before:scale-x-100",
      )}
    >
      {children}
      <svg
